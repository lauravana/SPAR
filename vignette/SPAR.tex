...
#>     return(out)
#>   }
#> <bytecode: 0x119895e78>
#> <environment: 0x119883040>
\end{verbatim}

The function returns a \class{screencoef} object which is a list
containing three elements: a character \texttt{name}, a function
\texttt{generate\_fun} returning a \(p\) dimensional vector of the
screening coefficients and a list of \texttt{control} arguments useful
in \texttt{generate\_fun}. More details on the construction of such
objects is
...
\begin{verbatim}
R> rp_cannings <- constructor_randomprojection("rp_cannings",
